...
export default function BasicTable(props) {
  ...
  const openEditModal = (e) => {
    ...
    console.log(value);
    //assigning to student object
    setStudent(value);
    handleOpen();
  };

  //uneditable view mode
    ...
    <>
      ...
      {view && (
        ...
        >
          ...
          >
            <p>
              <b>Name </b> -{student.firstName} {student.middleName}{" "}
              {student.lastName}
            </p>
            <br />
            <p>
            ...
            <br />
            <p>
              <b>RollNumber</b> -{student.rollNo}
            </p>
            <br />
            <p>
              <b>Address </b>-{student.addressLine1} {student.addressLine2}
            </p>
            <br />
            <p>
              <b>Landmark</b> -{student.landmark}
            </p>
            <br />
            <p>
